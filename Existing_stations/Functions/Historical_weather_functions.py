...
def historical_weather_load(end_date, date_format="%Y-%m-%d %H:%M:%S", path="../Existing_stations/Data/Weather/"):
    """
...
def historical_weather_transformations(weather_dict, window_width=2, date_format="%Y-%m-%d %H:%M:%S"):
    ...
    for station in weather_dict:
        ...
        mod_hist_weather_file = open('../Existing_stations/Data/Weather/hist_mod_weather_dict.pickle', "wb")
...
def create_weather_stats(weather_dict, metadata_dict, column_list_default=True,
    ...
    df_stats.to_csv('../Existing_stations/Data/Weather/weather_time_series.csv')
    return
