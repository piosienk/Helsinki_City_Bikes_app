...
def forecast_weather_download(path="./Data/Weather/Weather_data/"):
    ...
    querystring = {"location":"Helsinki","aggregateHours":"1","shortColumnNames":"false","unitGroup":"metric","contentType":"csv"}
    ...
    df = df.iloc[1:,:]
    df.columns = ["Address","Date time","Latitude","Longitude","Address", "Region", "Country", "Name","Wind Direction",
